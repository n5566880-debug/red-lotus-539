...
def calculate_witch_chaos():
    ...
    target_num = 26 
    reason = "火秋氣場過強，自動演算『水(26)』進行冷卻干擾。"
...
def get_pressure_data():
    ...
    # 實際使用時應接上遺漏統計
    return [
        (24, 32, "level-critical", "#FF0000", "🚨 極危"),
        (34, 30, "level-critical", "#FF0000", "🚨 極危"),
        (25, 18, "level-warning", "#FFD700", "⚠️ 蓄能"),
        (9, 12, "level-warning", "#FFD700", "⚠️ 蓄能"),
        (26, 8, "level-safe", "#32CD32", "🟢 平穩"),
        (17, 5, "level-safe", "#32CD32", "🟢 平穩")
    ]
...
with col_main:
    ...
    st.markdown('<h3 style="color:#FFD700;">⚔️ 統帥・五星總攻 (1/9)</h3>', unsafe_allow_html=True)
